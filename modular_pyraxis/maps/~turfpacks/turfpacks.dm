...
// PYRAXIS ATMOS
#define TURFPACK_PACKNAME pyraxis
#define TURFPACK_TEMP PYRAXIS_AVG_TEMP
#define TURFPACK_O2 PYRAXIS_MOL_O2
#define TURFPACK_N2 PYRAXIS_MOL_N2
#define TURFPACK_PHORON 0
#define TURFPACK_CO2 PYRAXIS_MOL_CO2
